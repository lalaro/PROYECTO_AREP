package com.eci.arep.restaurant_service.listener;
...
public class MessageListener {
    ...
    public void receiveMessage(String message) {
        ...
        System.out.println(">>> Mensaje Procesado a normal: " + message);
    }
    ...
    public void receiveMessageQueuePremium(String message) {
        ...
        // Aquí puedes añadir la lógica para procesar el mensaje
        // Por ejemplo: guardar en base de datos, llamar a otra API, etc.
        System.out.println(">>> Mensaje Procesado por la COLA PREMIUM: " + message);
    }
}